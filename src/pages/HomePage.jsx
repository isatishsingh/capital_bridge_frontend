...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    feedback:
      "Admin moderation gave our investors confidence while we scaled visibility for our campaign.",
  },
];
        ...
        <div className="page-shell grid gap-12 py-20 lg:grid-cols-[1.08fr_0.92fr] lg:py-28">
          <div className="relative z-10">
            ...
            <h1 className="mt-8 max-w-3xl font-display text-5xl font-bold leading-[1.04] text-ink sm:text-6xl">
              Back breakout founders with the same clarity you expect from
              world-class SaaS.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              CapitalBridge connects investors, startup creators, and admins in
              one transparent flow: discover projects, manage approvals, process
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="rounded-3xl bg-white/10 p-5 sm:col-span-2">
                    <p className="text-sm text-white/70">
                      Average campaign completion
                    </p>
                    <p className="mt-3 font-display text-4xl font-bold">
                      71 days
                    </p>
                    <p className="mt-3 text-sm leading-7 text-white/70">
                      Dashboards, approvals, and payment verification live in
        ...
        <div className="surface grid gap-8 p-8 lg:grid-cols-[0.8fr_1.2fr] lg:p-10">
          <div>
            ...
            <h2 className="mt-4 section-title">
              A platform designed for trust from day one.
            </h2>
          </div>
          <div>
            <p className="section-copy">
              CapitalBridge helps founders raise capital responsibly and gives
              investors a transparent path from discovery to verified payment.
              Every role gets the tools they need without losing the human side
              of fundraising.
            </p>
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="section-title mt-3">
              Funding opportunities with visible momentum.
            </h2>
          </div>
          <Link to="/projects">
            <Button tone="slate" variant="outline">
      ...
      <section className="page-shell py-10">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="section-title mt-3">
              People trust products that respect their time.
            </h2>
          </div>
      ...
      <section className="page-shell py-10">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="section-title mt-3">
              The most common platform questions, answered clearly.
            </h2>
          </div>
          <Link to="/faq">
            <Button tone="slate" variant="outline">
