...
export const ContactPage = () => (
  <div className="page-shell py-16">
    ...
    <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
      For platform support, trust and safety, or partnership enquiries, reach the CrowdSpring operations desk using the
      channels below.
    </p>
    <div className="mt-10 grid gap-6 md:grid-cols-2">
      <Card className="p-8">
        <h2 className="text-xl font-bold text-ink">Support</h2>
        <p className="mt-3 text-sm leading-7 text-slate-600">help@crowdspring.app</p>
